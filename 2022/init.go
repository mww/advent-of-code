...
import (
	...
	"theelements.org/advent-of-code/2022/day07"
...
func init() {
	...
	common.RegisterSolution(&common.ID{Year: 2022, Day: 7, Part: 1}, day07.P1)
	common.RegisterSolution(&common.ID{Year: 2022, Day: 7, Part: 2}, day07.P2)
}
